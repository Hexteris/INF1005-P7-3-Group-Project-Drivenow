...
if (isset($_SESSION['admin_id'])) { header("Location: " . BASE . "/admin/index.php"); exit(); }
...
<div class="dn-form-card" style="width:100%;max-width:400px;">
    ...
    <div class="text-center mt-3">
        <a href="<?php echo BASE; ?>/index.php" style="color:var(--text-muted);font-size:.85rem;">← Back to Site</a>
    </div>
</div>
</body>
</html>
