...
<nav class="admin-sidebar" role="navigation" aria-label="Admin navigation">
    ...
    <a href="<?php echo BASE; ?>/admin/manage-cars.php"     class="admin-nav-link <?php echo $currentPage==='manage-cars.php'?'active':''; ?>"><i class="bi bi-car-front"></i> Cars</a>
    <a href="<?php echo BASE; ?>/admin/manage-bookings.php" class="admin-nav-link <?php echo $currentPage==='manage-bookings.php'?'active':''; ?>"><i class="bi bi-calendar-check"></i> Bookings</a>
    <a href="<?php echo BASE; ?>/admin/manage-users.php"    class="admin-nav-link <?php echo $currentPage==='manage-users.php'?'active':''; ?>"><i class="bi bi-people"></i> Members</a>
    <a href="<?php echo BASE; ?>/admin/manage-reviews.php"  class="admin-nav-link <?php echo $currentPage==='manage-reviews.php'?'active':''; ?>"><i class="bi bi-star"></i> Reviews</a>
    <a href="<?php echo BASE; ?>/admin/manage-payments.php" class="admin-nav-link <?php echo $currentPage==='manage-payments.php'?'active':''; ?>"><i class="bi bi-credit-card"></i> Payments</a>
    <hr style="border-color:var(--border);margin:1rem 1rem;">
    <a href="<?php echo BASE; ?>/index.php"        class="admin-nav-link"><i class="bi bi-globe"></i> View Site</a>
    <a href="<?php echo BASE; ?>/admin/logout.php" class="admin-nav-link" style="color:#f94144;"><i class="bi bi-box-arrow-left"></i> Sign Out</a>
</nav>
